(function (factory) {
    ...
    _e(function (E, $) {
        ...
        MenuContainer.fn.init = function () {
            var self = this;
            var $menuContainer = $('<div class="JEditor-menu-container clearfix" style="height: 35px;"></div>');
    ...
    _e(function (E, $) {
        ...
        MenuContainer.fn._addOneMenu = function (menu) {
            ...
            var $item = $('<div class="menu-item clearfix" style="overflow: visible"></div>');
            $menuSelected.hide();
    ...
    _e(function (E, $) {
        ...
        // 超时时间 20分钟
        E.config.uploadTimeout = 20 * 60 * 1000;
        // 上传单个图片最大值    默认2M
    ...
    _e(function (E, $) {
        ...
        E.UI.menus = {
            ...
            insertshots: {
                normal:  '<a href="#" tabindex="-1">插入作品</a>',
                selected: '<a href="#" tabindex="-1" class="selected">插入作品</a>'
            },
        };
            ...
            $.each(configColors, function (k, v) {
                $content.append(
                    [
                        ...
                        '    style="margin: 5px;background-color: ' + k + '" ',
                        '><i class="jeditor-icon-pencil" style="display: none"></i></a>'
                    ].join('')
                );
            });
        ...
        E.plugin(function () {
            ...
            fns.onload || (fns.onload = function (resultText, xhr) {
                ...
                if (resultText.indexOf('error|') === 0) {
                    ...
                    resultText = resultJson.data.url || '';
    ...
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            editor.xhrUploadImg = function (opt) {
                ...
                var uploadCustomFn = editor.config.uploadCustomFn;
                // const uploadCustomFn = null

                // console.log('uploadCustomFn', uploadCustomFn)
                ...
                if (uploadCustomFn && (file || base64)) {   
                    const params = {
                        ...
                        onSuccess: function(ret) {
                            if (!uploadKey) {
                                const responseText = JSON.stringify(ret)
                                // 执行load函数，任何操作，都应该在load函数中定义
                                loadfn && loadfn.call(editor, responseText);
                                callbackSuccess && callbackSuccess(responseText, uploadKey);                       
                            }
                            // 隐藏进度条
                            editor.hideUploadProgress();
                        },
                ...
                if (file) {
                    ...
                    params.fileBase64 = base64.substring(base64.indexOf('base64,') + 7);
                } 
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function(check) {
            ...
            menu.clickEvent = function(e) {
                if (editor.insertShotsFn) {
                    editor.insertShotsFn()
                }
            }
...
(function ($) {
    ...
    E.createMenu(function (check) {
        ...
        function analysisUrl(url) {
            ...
            var source = {
                youku: {
                    name: 'youku',
                    domain: '.youku.com',
                    videoUrl: 'https://player.youku.com/embed/{{video_id}}'
                },
                tudou: {
                    name: 'tudou',
                    domain: '.tudou.com',
                    videoUrl: 'https://www.tudou.com/programs/view/html5embed.action?code={{code}}&lcode={{lcode}}'
                }
            };
        ...
        function networkContentHandler(editor, menu, $networkContent) {
            var lang = editor.config.lang;
            var $urlContainer = $('<div class="network-container"></div>');
            var $urlInput = $('<input type="text" class="block" placeholder="腾讯视频支持粘贴通用代码,其他视频网站支持网址和通用代码">');
            $urlContainer.append($urlInput);
    ...
    E.plugin(function () {
        ...
        function updateProgress(e) {
            if (e.lengthComputable) {
                ...
                editor.showUploadProgressVideo(e.percent);
            }
        }
    ...
    E.plugin(function () {
        ...
        var $progress, $percentage, $progressLabel, $completePreview, $completeLabel, $btnCompleteCancel,
            $btnCompleteInsert, $dot;
        ...
        editor.hideUploadProgressVideo = function (url) {
            ...
            if (url) {
                ...
                var $video = $(`<video src="${currVideoUrl}" width="100%" height="100%" />`);
                $completePreview.empty().append($video);
            }
        };
    ...
    E.plugin(function () {
        ...
        $btnCompleteInsert.click(function (event) {
            ...
            var url = $completePreview.find('video').attr('src');
            if (url) {
                // var html = '<iframe src="' + url + '" style="width:640px; height:498px; max-width:100%;" frameborder=0 allowfullscreen/>';
                var html = `<video src="${url}" controls preload="${url}?vframe/png/offset/5/w/1024" />`
                editor.command(null, 'insertHtml', html);
                $uploadContent.removeClass('complete');
